...
begin
	...
	TestIs(TAPTester.Lines[3], '    1..1', 'subtest plan ok');
	TestIs(TAPTester.Lines[4], 'not ok 1 - this is a subtest', 'subtest testpoint ok');
	TestIs(TAPTester.Lines[5], '# Failed test ''this is a subtest''', 'subtest comment ok');
